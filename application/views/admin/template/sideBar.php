    ...
    <div class="wrapper">
        ...
        <aside id="left-sidebar-nav">
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                <li class="user-details cyan darken-2">
                    <div class="row">
                        <div class="col col s4 m4 l4">
                            <img src="<?php echo base_url("assets/images/user/{$admin['foto']}") ?>" alt="" class="circle responsive-img valign profile-image" style="background: #fff">
                        </div>
                        <div class="col col s8 m8 l8">
                            <ul id="profile-dropdown" class="dropdown-content">
                                ...
                                <li><a href="<?php echo base_url('admin/logout_adm') ?>"><i class="mdi-hardware-keyboard-tab"></i> Logout</a>
                                </li>
                            </ul>
                            <a class="btn-flat dropdown-button waves-effect waves-light white-text profile-btn" href="#" data-activates="profile-dropdown"><?php echo $admin['nome_responsavel'] ?><i class="mdi-navigation-arrow-drop-down right"></i></a>
                ...
                <li class="bold"><a href="<?php echo base_url('admin/_servicos')?>" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Serviços</a>
