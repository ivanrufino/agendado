<div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
        <div class="container">
            <br><br>
            <h1 class="header center teal-text text-lighten-2">Agendamentos On-line</h1>
            <div class="row center">
                <h5 class="header col s12 light">Um ambiente onde você pode encontrar diversos serviços e agenda-los totalmente on-line</h5>
            </div>
            <div class="row center">
                <a href="servicos" id="download-button" class="btn-large waves-effect waves-light teal lighten-1">Comece por aqui</a>
            </div>
            <br><br>
